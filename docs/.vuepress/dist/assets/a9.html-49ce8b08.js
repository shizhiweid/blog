import{_ as e,o as r,c as n,a as s}from"./app-68d0c3d2.js";const t={},a=s(`<h2 id="数组常用方法" tabindex="-1"><a class="header-anchor" href="#数组常用方法" aria-hidden="true">#</a> 数组常用方法</h2><p><strong>1. join(原数组不受影响)</strong> 该方法可以将数组里的元素，通过指定的分隔符，以字符串的形式连接起来。 返回值：返回一个新的字符串</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>//将数组用 - 符号连接起来
let arr = [1,2,3,4,5];
let str = arr.join(&#39;-&#39;);
