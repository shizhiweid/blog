import{_ as e,o as s,c as t,a as n}from"./app-fb7751c8.js";const l={},i=n(`<p><strong>1.chartAt</strong> 返回字符串中指定位置的字符 ==<strong>结构：</strong>== str.chartAt(ind);返回下标为ind的字符</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>let str=&#39;abcde&#39;
