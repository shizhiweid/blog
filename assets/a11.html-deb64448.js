import{_ as e,o as n,c as i,a as s}from"./app-0ef2e6a1.js";const l={},a=s(`<h2 id="nginx中的proxy-pass有uri问题" tabindex="-1"><a class="header-anchor" href="#nginx中的proxy-pass有uri问题" aria-hidden="true">#</a> nginx中的proxy_pass有uri问题</h2><p>nginx中proxy_pass中如果带有uri那么location中的匹配的将会被替换掉，如果不带uri那么·proxy_pass将会替换掉location所匹配的前面的东西</p><p>例子：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> proxy_pass没带路径
